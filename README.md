...
![Геометрическая вероятность](./target_plot.png)
...
![Парадокс Симпсона](./simpson_plot.png)
...
![Дискретные распределения](./discrete_distributions.png)
...
![Нормальное распределение](./normal_dist_plot.png)
